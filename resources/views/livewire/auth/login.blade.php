                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="username" name="username" type="text" wire:model="username"
                            class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm @error('username') border-red-500 @enderror"
                ...
                <div class="mt-6 border-t border-gray-200 pt-6">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-xs">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-500">manager1 / password</p>
                        </div>
                        <div class="text-center">
                            <p class="font-medium">Karyawan</p>
                            <p class="text-gray-500">budi01 / password</p>
                        </div>
                    </div>
                </div>
            @endif
