                ...
                <form wire:submit.prevent="save" class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="radio" wire:model.live="type" value="in" class="text-green-600 focus:ring-green-500">
                                <span class="px-4 py-2 rounded-lg {{ $type == 'in' ? 'bg-green-100 text-green-800 font-semibold' : 'bg-gray-100 text-gray-700' }}">
                                    <i class="fas fa-arrow-down mr-2"></i>Barang Masuk
                                </span>
                            </label>
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="radio" wire:model.live="type" value="out" class="text-red-600 focus:ring-red-500">
                                <span class="px-4 py-2 rounded-lg {{ $type == 'out' ? 'bg-red-100 text-red-800 font-semibold' : 'bg-gray-100 text-gray-700' }}">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex gap-4 mb-4">
                            <button type="button" onclick="openCamera()" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                                <i class="fas fa-camera mr-2"></i>Ambil Foto
                            </button>
                            <label class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition cursor-pointer">
                        ...
                        <div id="cameraModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                            <div class="bg-white rounded-lg p-6 max-w-2xl w-full">
                                ...
                                <div class="flex gap-2">
                                    <button type="button" onclick="capturePhoto()" class="flex-1 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                                        <i class="fas fa-camera mr-2"></i>Ambil Gambar
                                    </button>
                                    <button type="button" onclick="closeCamera()" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">
                                        Batal
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="mt-4">
                            @if ($photo)
                                <div class="relative inline-block">
                                    <img src="{{ $photo->temporaryUrl() }}" class="h-40 rounded-lg border-2 border-green-500">
                            ...
                            @if ($capturedPhoto)
                                <div class="relative inline-block">
                                    <img src="{{ $capturedPhoto }}" class="h-40 rounded-lg border-2 border-green-500">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea wire:model="notes" id="notes" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Tambahkan catatan jika diperlukan..."></textarea>
